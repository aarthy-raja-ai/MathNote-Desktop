...
const SettingsScreen: React.FC = () => {
    ...
    const handleExport = () => {
        ...
        a.href = url;
        a.download = `mathnote-backup-${new Date().toISOString().split('T')[0]}.json`;
        a.click();
    ...
    return (
        <div className="animate-in" style={{ maxWidth: 800 }}>
            ...
            <div className="card" style={{ marginBottom: '1rem' }}>
                ...
                <div className="flex flex-between" style={{ padding: '1rem 0', borderBottom: '1px solid var(--color-border-light)' }}>
                    <div><div style={{ fontWeight: 500 }}>Export Backup Manual</div><div style={{ fontSize: '0.8rem', color: 'var(--color-text-secondary)' }}>Download all your data as a JSON file</div></div>
